...
# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := SRPRE09A013RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 21133856 # This is the maximum known partition size, but it can be higher, so we just omit it
